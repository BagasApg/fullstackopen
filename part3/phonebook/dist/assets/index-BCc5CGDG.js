...
` +
    ...
    var M = Math.random().toString(36).slice(2),
      ft = `__reactFiber$` + M,
      pt = `__reactProps$` + M,
      mt = `__reactContainer$` + M,
      ht = `__reactEvents$` + M,
      gt = `__reactListeners$` + M,
      _t = `__reactHandles$` + M,
      vt = `__reactResources$` + M,
      yt = `__reactMarker$` + M;
    function bt(e) {
...
var le = ce(),
  ue = le.FormData === void 0 ? void 0 : le.FormData,
  de = (e) => {
    if (!e) return !1;
  ...
  fe = _(`URLSearchParams`),
  [A, pe, me, he] = [`ReadableStream`, `Request`, `Response`, `Headers`].map(_),
  ge = (e) =>
...
var ye =
  ...
  be = (e) => !b(e) && e !== ye;
function xe(...e) {
  let { caseless: t, skipUndefined: n } = (be(this) && this) || {},
    r = {},
    i = (e, i) => {
  ...
  for (let t = 0, n = e.length; t < n; t++) e[t] && _e(e[t], i);
  return r;
}
var Se = (e, t, n, { allOwnKeys: r } = {}) => (
    _e(
      t,
      (t, r) => {
        n && T(t)
  ...
  Ce = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e),
  we = (e, t, n, r) => {
  ...
  Re = () => {},
  ze = (e, t) => (e != null && Number.isFinite((e = +e)) ? e : t);
function Be(e) {
  return !!(e && T(e.append) && e[h] === `FormData` && e[m]);
}
var Ve = (e) => {
    let t = new WeakSet(),
      n = (e) => {
  ...
  He = _(`AsyncFunction`),
  Ue = (e) => e && (E(e) || T(e)) && T(e.then) && T(e.catch),
  We = ((e, t) =>
    e
      ? setImmediate
      : t
        ? ((e, t) => (
            ye.addEventListener(
              `message`,
              ({ source: n, data: r }) => {
                n === ye && r === e && t.length && t.shift()();
              },
              !1,
            ),
            (n) => {
              (t.push(n), ye.postMessage(e, `*`));
            }
          ))(`axios@${Math.random()}`, [])
        : (e) => setTimeout(e))(
  ...
  j = {
    ...
    asap:
      typeof queueMicrotask < `u`
        ? queueMicrotask.bind(ye)
        : (typeof process < `u` && process.nextTick) || We,
    isIterable: (e) => e != null && T(e[m]),
  },
  Ge = j.toObjectSet([
    `age`,
    `authorization`,
...
var Je = RegExp(`[\\u0000-\\u0008\\u000a-\\u001f\\u007f]+`, `g`),
  Ye = RegExp(`[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+`, `g`);
function Xe(e, t) {
  return j.isArray(e) ? e.map((e) => Xe(e, t)) : qe(String(e).replace(t, ``));
}
var Ze = (e) => Xe(e, Je),
  Qe = (e) => Xe(e, Ye);
function $e(e) {
...
var et = Symbol(`internals`);
function tt(e) {
  return e && String(e).trim().toLowerCase();
}
function nt(e) {
  return e === !1 || e == null ? e : j.isArray(e) ? e.map(nt) : Ze(String(e));
}
function rt(e) {
  let t = Object.create(null),
    n = /([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g,
...
var ct = class {
  ...
  set(e, t, n) {
    ...
    else if (j.isString(e) && (e = e.trim()) && !it(e)) a(Ke(e), t);
...
(ct.accessor([
  ...
  j.reduceDescriptors(ct.prototype, ({ value: e }, t) => {
...
function dt(e, t) {
  let n = new Set(t.map((e) => String(e).toLowerCase())),
    ...
    i = (e) => {
      ...
      (e instanceof ct && (e = e.toJSON()), r.push(e));
      let t;
      if (j.isArray(e))
        ((t = []),
          e.forEach((e, n) => {
        ...
        if (!j.isPlainObject(e) && ut(e)) return (r.pop(), e);
...
var M = class e extends Error {
  ...
  toJSON() {
    let e = this.config,
      ...
      n = j.isArray(t) && t.length > 0 ? dt(e, t) : j.toJSONObject(e);
    return {
...
function ht(e) {
  return j.isArray(e) && !e.some(ft);
}
var gt = j.toFlatObject(j, {}, null, function (e) {
...
function _t(e, t, n) {
  ...
  function d(e, n, i) {
    ...
    if (j.isReactNative(t) && j.isReactNativeBlob(e))
      return (t.append(mt(i, n, a), u(e)), !1);
...
var Ct = class {
  ...
  Ot = (typeof navigator == `object` && navigator) || void 0,
  kt =
    Dt &&
    (!Ot || [`ReactNative`, `NativeScript`, `NS`].indexOf(Ot.product) < 0),
  At =
    typeof WorkerGlobalScope < `u` &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == `function`,
  jt = (Dt && window.location.href) || `http://localhost`,
  Mt = { ...Et, ...Tt };
function Nt(e, t) {
  return _t(e, new Mt.classes.URLSearchParams(), {
    visitor: function (e, t, n, r) {
      return Mt.isNode && j.isBuffer(e)
    ...
    return (
      ...
      s
        ...
        : ((!j.hasOwnProp(r, a) || !j.isObject(r[a])) && (r[a] = []),
          t(e, n, r[a], i) && j.isArray(r[a]) && (r[a] = Ft(r[a])),
          !o)
    );
  }
...
var Lt = (e, t) => (e != null && j.hasOwnProp(e, t) ? e[t] : void 0);
function Rt(e, t, n) {
  if (j.isString(e))
    try {
...
var zt = {
  ...
  transformRequest: [
    function (e, t) {
      ...
      let a;
      if (i) {
        let t = Lt(this, `formSerializer`);
        if (n.indexOf(`application/x-www-form-urlencoded`) > -1)
          return Nt(e, t).toString();
      ...
      return i || r ? (t.setContentType(`application/json`, !1), Rt(e)) : e;
    },
  ],
  transformResponse: [
    function (e) {
      let t = Lt(this, `transitional`) || zt.transitional,
        n = t && t.forcedJSONParsing,
        r = Lt(this, `responseType`),
        i = r === `json`;
      if (j.isResponse(e) || j.isReadableStream(e)) return e;
      if (e && j.isString(e) && ((n && !r) || i)) {
        let n = !(t && t.silentJSONParsing) && i;
        try {
          return JSON.parse(e, Lt(this, `parseReviver`));
        } catch (e) {
          if (n)
            throw e.name === `SyntaxError`
              ? M.from(e, M.ERR_BAD_RESPONSE, this, null, Lt(this, `response`))
              : e;
        }
      }
      return e;
...
var rn = [`content-type`, `content-length`];
function an(e, t, n) {
  if (n !== `content-only`) {
    e.set(t);
    return;
  ...
  Object.entries(t).forEach(([t, n]) => {
    rn.includes(t.toLowerCase()) && e.set(t, n);
  });
}
var on = (e) =>
  ...
  sn = (e) => {
    ...
    if (
      ...
      (t.url = St(en(l, d, u), e.params, e.paramsSerializer)),
      c &&
        s.set(
          `Authorization`,
          `Basic ` +
            btoa((c.username || ``) + `:` + (c.password ? on(c.password) : ``)),
        ),
      j.isFormData(r) &&
        (Mt.hasStandardBrowserEnv || Mt.hasStandardBrowserWebWorkerEnv
          ? s.setContentType(void 0)
          : j.isFunction(r.getHeaders) &&
            an(s, r.getHeaders(), n(`formDataHeaderPolicy`))),
      Mt.hasStandardBrowserEnv &&
        (j.isFunction(i) && (i = i(t)), i === !0 || (i == null && Xt(t.url))))
    ) {
      let e = a && o && Zt.read(o);
      e && s.set(a, e);
    }
    ...
    let n = new AbortController(),
      ...
      i = function (e) {
        if (!r) {
          ...
          n.abort(
            t instanceof M ? t : new Ht(t instanceof Error ? t.message : t),
          );
        }
      },
      a =
...
var hn = `1.16.1`,
  ...
  yn = (e) => {
    ...
    let { fetch: i, Request: a, Response: o } = e,
      s = i ? _n(i) : typeof fetch == `function`,
      c = _n(a),
      l = _n(o);
    if (!s) return !1;
    let u = s && _n(n),
      ...
      p = l && u && vn(() => j.isReadableStream(new o(``).body)),
      m = { stream: p && ((e) => e.body) };
    s &&
    ...
    let h = async (e) => {
        ...
        if (j.isSpecCompliantForm(e))
          return (
            await new a(Mt.origin, { method: `POST`, body: e }).arrayBuffer()
          ).byteLength;
    ...
    return async (e) => {
      ...
      let E = ln([l, u && u.toAbortSignal()], d),
        D = null,
        te =
          E &&
          E.unsubscribe &&
        ...
        ne;
      try {
        if (w && typeof t == `string` && t.startsWith(`data:`) && mn(t) > S)
          throw new M(
        ...
        y.set(`User-Agent`, `axios/` + hn, !1);
        let l = {
          ...x,
          signal: E,
          method: n.toUpperCase(),
          headers: $e(y.normalize()),
          body: s,
          duplex: `half`,
        ...
        v ||= `text`;
        let re = await m[j.findKey(m, v) || `text`](u, e);
        if (w && !p && !d) {
          let t;
          if (
            (re != null &&
              (typeof re.byteLength == `number`
                ? (t = re.byteLength)
        ...
        if ((te && te(), E && E.aborted && E.reason instanceof M)) {
          let n = E.reason;
          throw (
            (n.config = e),
            D && (n.request = D),
        ...
        throw t &&
          ...
          ? Object.assign(
              new M(`Network Error`, M.ERR_NETWORK, e, D, t && t.response),
              { cause: t.cause || t },
            )
          : M.from(t, t && t.code, e, D, t && t.response);
      }
    };
  },
  bn = new Map(),
  xn = (e) => {
    ...
    for (; o--;)
      ((s = a[o]),
        (c = l.get(s)),
        c === void 0 && l.set(s, (c = o ? new Map() : yn(t))),
        (l = c));
    return c;
  };
xn();
var Sn = { http: null, xhr: cn, fetch: { get: xn } };
j.forEach(Sn, (e, t) => {
  if (e) {
    try {
...
var Cn = (e) => `- ${e}`,
  wn = (e) => j.isFunction(e) || e === null || e === !1;
function Tn(e, t) {
  e = j.isArray(e) ? e : [e];
  let { length: n } = e,
    r,
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((i = r),
      !wn(r) && ((i = Sn[(n = String(r)).toLowerCase()]), i === void 0))
    )
...
var En = { getAdapter: Tn, adapters: Sn };
function Dn(e) {
  if (
  ...
  return (
    ...
    En.getAdapter(
      ...
      function (t) {
        ...
        return ((t.headers = ct.from(t.headers)), t);
      },
      function (t) {
        if (!Vt(t) && (Dn(e), t && t.response)) {
          e.response = t.response;
          try {
            t.response.data = Bt.call(e, e.transformResponse, t.response);
          } finally {
            delete e.response;
          }
...
var Mn = { assertOptions: jn, validators: kn },
  Nn = Mn.validators,
  Pn = class {
    constructor(e) {
      ((this.defaults = e || {}),
...
(j.forEach([`delete`, `get`, `head`, `options`], function (e) {
  Pn.prototype[e] = function (t, n) {
    return this.request(
      nn(n || {}, { method: e, url: t, data: (n || {}).data }),
    );
  };
}),
  j.forEach([`post`, `put`, `patch`, `query`], function (e) {
    ...
    ((Pn.prototype[e] = t()),
      e !== `query` && (Pn.prototype[e + `Form`] = t(!0)));
  }));
var Fn = class e {
  constructor(e) {
...
function zn(e) {
  let t = new Pn(e),
    n = d(Pn.prototype.request, t);
  return (
    j.extend(n, Pn.prototype, t, { allOwnKeys: !0 }),
...
((N.Axios = Pn),
  ...
  (N.mergeConfig = nn),
  (N.AxiosHeaders = ct),
  (N.formToJSON = (e) => It(j.isHTMLForm(e) ? new FormData(e) : e)),
...
var Bn = i(),
  ...
  Hn = `/api/persons`,
  Un = {
    getAll: () => N.get(Hn).then((e) => e.data),
    create: (e) => N.post(Hn, e).then((e) => e.data),
    update: (e, t) => N.put(`${Hn}/${e}`, t).then((e) => e.data),
    remove: (e) => N.delete(`${Hn}/${e}`).then((e) => e.data),
  },
  Wn = t((e) => {
    var t = Symbol.for(`react.transitional.element`);
    function n(e, n, r) {
  ...
  Gn = ({ onChange: e }) =>
    (0, P.jsxs)(`div`, {
      children: [`filter shown with `, (0, P.jsx)(`input`, { onChange: e })],
    }),
  Kn = (e) =>
    (0, P.jsxs)(`form`, {
      ...
      children: [
        (0, P.jsxs)(`div`, {
          children: [
            `name: `,
            (0, P.jsx)(`input`, { onChange: e.handleNameInput }),
          ],
        }),
        (0, P.jsxs)(`div`, {
          children: [
            `number: `,
            (0, P.jsx)(`input`, { onChange: e.handleNumberInput }),
          ],
        }),
        (0, P.jsx)(`div`, {
          children: (0, P.jsx)(`button`, { type: `submit`, children: `add` }),
        }),
      ],
    }),
  qn = (e) =>
    (0, P.jsx)(`div`, {
      children: e.personsToShow.map((t) =>
        (0, P.jsxs)(
          `div`,
          {
            children: [
  ...
  Jn = ({ type: e, message: t }) =>
    t === null ? null : (0, P.jsx)(`div`, { className: e, children: t });
(0, Vn.createRoot)(document.getElementById(`root`)).render(
  (0, P.jsx)(Bn.StrictMode, {
    children: (0, P.jsx)(() => {
      let [e, t] = (0, Bn.useState)([]),
        [n, r] = (0, Bn.useState)({ name: ``, number: `` }),
        [i, a] = (0, Bn.useState)(``),
        [o, s] = (0, Bn.useState)(null),
        [c, l] = (0, Bn.useState)(``);
      (0, Bn.useEffect)(() => {
        Un.getAll().then((e) => {
          t(e);
      ...
      let u = (r) => {
          r.preventDefault();
          let i = e.find((e) => e.name.toLowerCase() === n.name.toLowerCase());
          if (i) {
            if (
              i.number !== n.number &&
              window.confirm(
              ...
              let r = { ...i, number: n.number };
              Un.update(i.id, r).then((n) => {
                t(e.map((e) => (e.id === i.id ? n : e)));
              });
            }
          } else
            Un.create(n)
        ...
        d = (n) => () => {
          ...
          window.confirm(`Delete ${r.name} ?`) &&
            Un.remove(n)
              ...
              .catch((i) => {
                (s(
                  `Information of ${r.name} has already been removed from server`,
                ),
                  l(`danger`),
                  setTimeout(() => {
                    (s(null), l(``));
        ...
        p = (e) => {
          r({ ...n, number: e.target.value });
        },
        m = (e) => {
          a(e.target.value);
        },
        h = e.filter((e) => e.name.includes(i));
      return (0, P.jsxs)(`div`, {
        children: [
          (0, P.jsx)(`h2`, { children: `Phonebook` }),
          (0, P.jsx)(Jn, { type: c, message: o }),
          (0, P.jsx)(Gn, { onChange: m }),
          (0, P.jsx)(`h2`, { children: `add a new` }),
          (0, P.jsx)(Kn, {
            addPerson: u,
            handleNameInput: f,
            handleNumberInput: p,
          }),
          (0, P.jsx)(`h2`, { children: `Numbers` }),
          (0, P.jsx)(qn, { personsToShow: h, deletePerson: d }),
        ],
      });
    }, {}),
  }),
